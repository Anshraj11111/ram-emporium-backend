...
const { createBillSchema, updateBillSchema, convertQuotationSchema } = require('../../validators/bill.validators');
...
router.patch('/:id',                               validate(updateBillSchema), controller.update);
